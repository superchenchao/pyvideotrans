...
class WinActionBase:
    ...
    def set_biaozhun(self):
        ...
        self.main.subtitle_removal_provider.show()
        self.main.subtitle_removal_settings.show()
    ...
    def set_tiquzimu(self):
        ...
        self.main.subtitle_removal_provider.hide()
        self.main.subtitle_removal_settings.hide()
    ...
    def disabled_widget(self, type):
        ...
        self.main.subtitle_removal_provider.setDisabled(type)
        self.main.subtitle_removal_settings.setDisabled(type)
