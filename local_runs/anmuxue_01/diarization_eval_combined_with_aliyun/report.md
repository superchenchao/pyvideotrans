...
- Subtitle lines: 101
- CSV: `E:/web/pyvideotrans/local_runs/anmuxue_01/diarization_eval_combined_with_aliyun/line_speaker_compare.csv`

## Summary

| Model | Lines | Speakers | Transitions | Seconds | Distribution |
|---|---:|---:|---:|---:|---|
| existing:01-fen-mp4 | 101/101 | 5 | 34 |  | spk0:19, spk1:36, spk2:15, spk3:30, spk4:1 |
...
| existing:diarization_eval_aliyun_funasr | 101/101 | 8 | 32 |  | spk0:12, spk1:1, spk2:17, spk3:35, spk4:10, spk5:17, spk6:5, spk7:3 |
...
|---|---:|---:|---:|
| existing:01-fen-mp4 vs existing:diarization_eval | 101 | 0.185 | 0.492 |
| existing:01-fen-mp4 vs existing:diarization_eval_ali_cam | 101 | 1.000 | 1.000 |
| existing:01-fen-mp4 vs existing:diarization_eval_pyannote | 101 | 0.378 | 0.532 |
| existing:01-fen-mp4 vs existing:diarization_eval_aliyun_funasr | 100 | 0.529 | 0.592 |
...
| existing:diarization_eval vs existing:diarization_eval_aliyun_funasr | 100 | 0.237 | 0.591 |
| existing:diarization_eval_ali_cam vs existing:diarization_eval_pyannote | 101 | 0.378 | 0.532 |
| existing:diarization_eval_ali_cam vs existing:diarization_eval_aliyun_funasr | 100 | 0.529 | 0.592 |
| existing:diarization_eval_pyannote vs existing:diarization_eval_aliyun_funasr | 100 | 0.430 | 0.569 |
