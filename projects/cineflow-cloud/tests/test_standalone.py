...
def test_directory_contains_everything_needed_when_moved_to_a_new_repo():
    required = [
        ...
        "docs/upload-worker.md",
        "docs/subtitle-worker.md",
        "docs/caption-worker.md",
        "docs/asr-worker.md",
        "docs/media-worker.md",
        "deploy/kubernetes/upload-worker.yaml",
        "deploy/kubernetes/subtitle-worker.yaml",
        "deploy/kubernetes/caption-worker.yaml",
